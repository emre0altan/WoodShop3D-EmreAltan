...
public class MegaLoftLayerMultiMatComplexEditor : MegaLoftLayerBaseEditor
{
	...
	Vector3 Slider(Vector3 pos, Vector3 dir, float size)
	{
#if UNITY_5_6 || UNITY_2017 || UNITY_2018
		return Handles.Slider(pos, dir, size, Handles.SphereHandleCap, 0.0f);
#else
		return Handles.Slider(pos, dir, size, Handles.SphereCap, 0.0f);
#endif
	}
